...
const ORIGIN = process.env.GITHUB_REPOSITORY_OWNER && process.env.REPOSITORY_NAME ?
	"https://".concat(process.env.GITHUB_REPOSITORY_OWNER.concat(".github.io/").concat(process.env.REPOSITORY_NAME)) :
	"http://localhost:9000";
