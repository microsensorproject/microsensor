...
JSON_REPORT=$(curl -X POST http://127.0.0.1:8080/api/v1/report -H 'Content-Type: application/json' -d "$REQUEST_JSON_PAYLOAD")
echo "::set-output name=json_report::$JSON_REPORT"
